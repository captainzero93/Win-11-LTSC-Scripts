...
- Reboot.
- Remove / Reinstall Snip tool ( win + alt + s ) giving the user a choice to install a software that has automatic saving like w11 Home ( and use the same hotkey) --  remove-snip-tool.bat / reinstall-snip-tool.bat
